...
| [`censorCaptions`](./docs/WORKFLOWS.md#caption-censorship) | Detect and censor profanity in captions | OpenAI, Anthropic, Google | Yes |
...
const result = await censorCaptions("your-asset-id", "track-id", {
  provider: "anthropic",
...
console.log(result.censoredWords); // ["fuck", "shit", "brandname"]
console.log(result.replacementCount); // 7
```
