...
const EnvSchema = z.object({
  ...
  AWS_BEARER_TOKEN_BEDROCK: optionalString("Amazon Bedrock bearer token API key (optional alternative to SigV4 auth)."),
  BEDROCK_AWS_REGION: optionalString("Amazon Bedrock region (fallback: AWS_REGION)."),
  AWS_REGION: optionalString("AWS region for Bedrock requests (used when BEDROCK_AWS_REGION is unset)."),
  AWS_ACCESS_KEY_ID: optionalString("AWS access key ID for Bedrock SigV4 authentication."),
  AWS_SECRET_ACCESS_KEY: optionalString("AWS secret access key for Bedrock SigV4 authentication."),
  AWS_SESSION_TOKEN: optionalString("AWS session token for temporary Bedrock credentials."),
  GOOGLE_VERTEX_PROJECT: optionalString("Google Cloud project ID for Vertex AI."),
  GOOGLE_VERTEX_LOCATION: optionalString("Google Cloud location/region for Vertex AI."),
  GOOGLE_VERTEX_API_KEY: optionalString("Google Vertex API key (express mode)."),
  GOOGLE_CLIENT_EMAIL: optionalString("Google service account client email for Vertex AI auth."),
  GOOGLE_PRIVATE_KEY: optionalString("Google service account private key for Vertex AI auth."),
  GOOGLE_PRIVATE_KEY_ID: optionalString("Google service account private key ID for Vertex AI auth."),
