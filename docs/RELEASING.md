...
This is the process a maintainer follows to cut a new release.
...
already match, someone's already bumped since the last release and you may just
...
8. **Post a heads-up in #robots Slack.** No automation for this yet.
