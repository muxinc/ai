...
- `model?: string` - AI model to use (defaults: `gpt-5.1`, `claude-sonnet-4-5`, `gemini-3-flash-preview`, `us.anthropic.claude-sonnet-4-5-20250929-v1:0`, or `gemini-3-flash-preview`)
...
- `model?: string` - Model to use (defaults: `text-embedding-3-small` for OpenAI, `gemini-embedding-001` for Google, `amazon.titan-embed-text-v2:0` for Bedrock, `text-embedding-005` for Vertex)
