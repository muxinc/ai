...
export const muxTestAssets = {
  ...
  /**
   * Asset used by chapters integration tests.
   * Recommended: an asset with an English transcript/captions track.
   */
  chaptersAssetId: env.MUX_TEST_ASSET_ID_CHAPTERS ?? "1XIUcA9k02nqRxCLpjHGzMYNIopCdSogkYrs98CThBrc",
  ...
  /** Audio-only asset for testing audio workflows (no video track). */
